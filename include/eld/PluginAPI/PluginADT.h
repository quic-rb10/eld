...
struct DLL_A_EXPORT Section {
  ...
  /// \note Common section is an internal input section each common section
  /// contains atleast one common symbol.
  ///
  /// \note Origin is the InputFile that originally defined the section.

  /// Returns the old inputFile of the section or the originating input file if
  /// the section is a common section.
  plugin::InputFile getOldInputFile() const;
